...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.promptModeBox = QComboBox(self.layoutWidget)
        self.promptModeBox.addItem("")
        self.promptModeBox.addItem("")
        self.promptModeBox.setObjectName(u"promptModeBox")

        self.horizontalLayout.addWidget(self.promptModeBox)

        self.addRatio = QRadioButton(self.layoutWidget)
        self.buttonGroup = QButtonGroup(Form)
        self.buttonGroup.setObjectName(u"buttonGroup")
        self.buttonGroup.addButton(self.addRatio)
        self.addRatio.setObjectName(u"addRatio")

        self.horizontalLayout.addWidget(self.addRatio)

        self.removeRatio = QRadioButton(self.layoutWidget)
        self.buttonGroup.addButton(self.removeRatio)
        self.removeRatio.setObjectName(u"removeRatio")
        self.removeRatio.setMinimumSize(QSize(40, 0))

        self.horizontalLayout.addWidget(self.removeRatio)
    ...
    def retranslateUi(self, Form):
        ...
        self.promptModeBox.setItemText(0, QCoreApplication.translate("Form", u"Point", None))
        self.promptModeBox.setItemText(1, QCoreApplication.translate("Form", u"Box", None))

        self.addRatio.setText(QCoreApplication.translate("Form", u"ADD", None))
        self.removeRatio.setText(QCoreApplication.translate("Form", u"REMOVE", None))
